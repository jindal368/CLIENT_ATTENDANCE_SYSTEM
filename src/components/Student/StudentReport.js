...
const StudentReport = () => {
  ...
  const attendanceFetchedData = useSelector(
    (state) => state.attendance.postAttendance
  );
  useEffect(() => {
    displayData(attendanceFetchedData);
  });

  const displayData = (resultArray) => {
    console.log("Data L : ", resultArray);
        ...
        <CardActionArea>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="textSecondary" component="p">
              Click to Check the Attendance of the student
            </Typography>
          </CardContent>
        </CardActionArea>
      </Card>
